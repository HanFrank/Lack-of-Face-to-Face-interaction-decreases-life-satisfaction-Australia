...
author: 
  ...
  - Tomoya Fujikawa
  - Ziyao Han
thanks: "Code and data are available at: https://github.com/HanFrank/STA304-Paper-3-"
...
The COVID-19 pandemic started in 2020 and people were forced to refrain from in-person contact, resulting in a major change in their lifestyle. School and jobs transferred online, and masks had to be worn at all times. This drastic change in lifestyle led to a decrease in the satisfaction level of individuals. In Australia in the very beginning, non-essential social gatherings such as party events were restricted, but most business operations including many retail categories remained available. After the vaccines became available, more than 90% of the population had completed their second dose by December 2021. Australia tried to pursue a zero-COVID suppression strategy until late 2021 by strictly controlling international arrivals and quickly responding to local outbreaks. This resulted in a relatively fast recovery of the economy compared to other developed countries [@citeForbes]. However, some people experienced a financial crisis, while some others experienced serious mental issues. The cause of the decrease in satisfaction scores varied among each other. Thus, it may be helpful to investigate what the biggest cause of the decrease in the satisfaction score was, in order to ensure that people are satisfied as the COVID-19 pandemic is still ongoing.

To investigate what the biggest cause of stress was in Australia, this paper aims to examine different variables to see if there is any correlation between the life satisfaction score and a certain variable. The data we will be using for the analysis is a response to the General Social Survey provided by the Australian Bureau of Statistics [@citeABS1]. The survey asked the citizens a variety of questions about their social experiences and mental health. We used the provided data and compared different variables to test which variable had the biggest influence on our independent variable, the overall satisfaction score. The results of our investigation indicates a significant decrease in the life satisfaction scores among citizens in Australia after the COVID-19 pandemic along with the number of face to face contact with friends and family living outside of their household. However, surprisingly, there was no other variable that showed a significant reduction during the pandemic. The paper consists of different tables and graphs for each variable showing the opposite result from what we expected initially. Thus, the reduction in the frequency of face to face contact seems to be the most influential factor. To investigate further to support our conclusion, we will also produce our own supplementary survey, asking more detailed and specific questions about our investigation.
